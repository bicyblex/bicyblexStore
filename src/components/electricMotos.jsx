...
export default function ElectricMotos() {
  ...
  const motos = [
    {
      ...
      name: "Volt-R 3000",
      price: "$2,890",
      image: "/moto1.png", // Guarda tu imagen en public/moto1.png
      autonomia: "85 KM",
    ...
    },
    {
      ...
      name: "Apex E-Moto",
      price: "$3,450",
      image: "/moto2.png", // Guarda tu imagen en public/moto2.png
      autonomia: "110 KM",
    ...
    },
    {
      ...
      name: "Neon S2",
      price: "$2,190",
      image: "/moto3.png", // Guarda tu imagen en public/moto3.png
      autonomia: "65 KM",
  ...
  return (
    <section className="w-full bg-[#0c0f0f] py-24 text-white border-t border-[#333535]/10">
      {/* CONTENEDOR PRINCIPAL: Manteniendo la caja exacta w-[90%] */}
      <div className="max-w-[1920px] m-auto w-[90%]">
        ...
        <div className="flex flex-col md:flex-row md:items-end justify-between border-b border-[#333535]/20 pb-8 mb-16">
          <div>
            ...
            <h2 className="text-[36px] sm:text-[48px] md:text-[56px] font-black uppercase tracking-tighter leading-none mt-2">
              Motos Eléctricas
            </h2>
          </div>

          <div className="flex items-center gap-4 mt-4 md:mt-0">
            <span className="text-xs font-bold uppercase tracking-[0.2em] text-[#ffb800] bg-[#ffb800]/10 px-3 py-1 border border-[#ffb800]/20">
              High Voltage Enabled
            </span>
          </div>
        </div>

        {/* CUADRÍCULA DE 3 COLUMNAS COMPACTAS */}
            ...
            return (
              ...
              >
                ...
                <div className="relative w-full h-[260px] bg-[#111414] overflow-hidden">
                  ...
                  />
                  {/* Etiqueta flotante */}
                  <div className="absolute top-4 left-4 bg-[#ffb800] text-black text-[10px] font-black uppercase tracking-widest px-3 py-1">
                    {moto.tag}
                  </div>
                </div>
                ...
                <div className="p-6 md:p-8 flex flex-col flex-grow justify-between">
                  <div>
                    ...
                    <h3 className="text-2xl font-black uppercase tracking-tighter leading-none flex items-baseline gap-x-2 flex-wrap">
                    ...
                    {/* Especificaciones Técnicas Simplificadas Tipo Ficha */}
                  ...
                  <div className="mt-8">
                    <button className="w-full bg-transparent border border-[#ffb800] text-[#ffb800] group-hover:bg-[#ffb800] group-hover:text-black font-bold text-xs uppercase tracking-[0.2em] py-3 transition-all duration-300">
                      Ordenar Ahora
                    </button>
                  </div>
                </div>
